...
// 	if ( $themedata['Version'] > $topf_options['theme_version'] )
// 	{
// 		// the Theme version is set in 'style.css'
// 		$topf_options['theme_version'] = $themedata['Version'];
// 		// make other adjustments based on specific versions here
// 		update_option( TOPF_OPTIONS, $topf_options );
// 	}
		...
		<div id="topf-header">
			...
			<div style="float:right;">
				<form method="post" action="https://www.paypal.com/cgi-bin/webscr" target="paypal">
					...
					<input type="hidden" name="bn"  value="DonateButton">
					<?php $icon = get_stylesheet_directory_uri().'/options/images/donate.gif'; ?>
					<input type="image" name="add" src="<?php echo $icon ?>">
				</form>
			</div>
			<div class="clear"></div>
		</div>
